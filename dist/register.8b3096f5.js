...
})({"1rzE2":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "9f2789c88b3096f5";
...
},{}],"jUMAO":[function(require,module,exports) {
...
const submitRegister = async (e)=>{
    try {
        ...
        const userData = await (0, _usersJs.registerUser)({
            data
        });
...
},{"../services/local-user.js":"d8OvD","../services/users.js":"bNxaK","../handlers/index.js":"8Xvt1"}],"d8OvD":[function(require,module,exports) {
...
},{"3b29b0b9fed8b83c":"lRN7P","eedbcf55c7dd5bcb":"fcbwn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lRN7P":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("dFaSa") + "cart-fill.eb29dcba.svg" + "?" + Date.now();
...
},{}],"fcbwn":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("dFaSa") + "person-circle.53fa02f7.svg" + "?" + Date.now();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1rzE2","jUMAO"], "jUMAO", "parcelRequire3b77")

//# sourceMappingURL=register.8b3096f5.js.map
