...
})({"8Y4wE":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "d2437611c9160713";
...
},{}],"8joHO":[function(require,module,exports) {
var _productInfoJs = require("../components/product/product-info.js");
var _productsJs = require("../services/products.js");
var _localCartJs = require("../services/local-cart.js");
const productContainer = document.getElementById("product-info-container");
const main = async ()=>{
    const urlParams = new URLSearchParams(location.search);
    const productId = urlParams.get("id");
    const productInfo = await (0, _productsJs.getProductById)(productId);
    productContainer.innerHTML = (0, _productInfoJs.generateProductInfo)(productInfo);
    const btnAddToCart = document.getElementById("add-to-cart");
    btnAddToCart.addEventListener("click", ()=>{
        (0, _localCartJs.addCartItem)(productInfo);
    });
};
main();

},{"../services/products.js":"ikEhu","../components/product/product-info.js":"ae3pg","../services/local-cart.js":"8g3D8"}],"ikEhu":[function(require,module,exports) {
...
},{"3b29b0b9fed8b83c":"d8Z6U","eedbcf55c7dd5bcb":"ZJjbE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8Z6U":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("i3e7B") + "cart-fill.eb29dcba.svg" + "?" + Date.now();
...
},{}],"ZJjbE":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("i3e7B") + "person-circle.53fa02f7.svg" + "?" + Date.now();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ae3pg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "generateProductInfo", ()=>generateProductInfo);
const generateProductInfo = ({ name , price , img  })=>`
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8g3D8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const addCartItem = (product)=>{
    ...
    else cart = cart.map((item)=>item.id === product.id ? {
            ...item,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8Y4wE","8joHO"], "8joHO", "parcelRequire3b77")

//# sourceMappingURL=producto-info.c9160713.js.map
