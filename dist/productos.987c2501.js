...
})({"3GMkx":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "a77fe8d3987c2501";
...
},{}],"jhTf0":[function(require,module,exports) {
var _productsJs = require("../services/products.js");
var _productJs = require("../components/product/product.js");
const main = async ()=>{
    const data = await (0, _productsJs.getAllProducts)();
    console.log([
        ...data
    ]);
    data.forEach((item)=>(0, _productJs.generateCardProduct)("#productos", item));
};
main();

},{"../services/products.js":"ikEhu","../components/product/product.js":"geZkh"}],"ikEhu":[function(require,module,exports) {
...
},{"3b29b0b9fed8b83c":"AodQt","eedbcf55c7dd5bcb":"2MwLt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"AodQt":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("enAZF") + "cart-fill.eb29dcba.svg" + "?" + Date.now();
...
},{}],"2MwLt":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("enAZF") + "person-circle.53fa02f7.svg" + "?" + Date.now();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"geZkh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "generateCardProduct", ()=>generateCardProduct);
const generateCardProduct = (selector, { id , name , by , img , price  })=>{
    const item = `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3GMkx","jhTf0"], "jhTf0", "parcelRequire3b77")

//# sourceMappingURL=productos.987c2501.js.map
